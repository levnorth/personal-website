              ...
              <div className="flex justify-between w-full">
                <div className="flex items-center">
                  <Link to="/">
                    <h1 className="text-2xl font-medium">
                      Levi<span className="text-orange-500">Blog</span>
                    </h1>
                  </Link>
                </div>
                <div className="hidden sm:ml-6 sm:flex sm:space-x-8">
                  <NavLink
                    ...
                    className={({ isActive }) =>
                      isActive
                        ? "border-orange-500  h-full inline-flex items-center px-1 pt-1 border-b-2 text-sm font-medium"
                  ...
                  <NavLink
                    ...
                    className={({ isActive }) =>
                      isActive
                        ? "border-orange-500 dark:bg-gray-900 dark:text-white h-full inline-flex items-center px-1 pt-1 border-b-2 text-sm font-medium"
                        : "border-transparent text-gray-500 dark:text-gray-300 dark:hover:text-white inline-flex items-center px-1 pt-1 border-b-2 text-sm font-medium"
                    }
                    to="/blog"
                  >
          ...
          <Disclosure.Panel className="sm:hidden">
            <div className="pt-2 pb-3 space-y-1">
              <NavLink
                ...
                className={({ isActive }) =>
                  isActive
                    ? "bg-teal-50 border-orange-500 text-orange-500 block pl-3 pr-4 py-2 border-l-4 text-base font-medium dark:bg-gray-800"
